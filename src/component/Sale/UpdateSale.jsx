                            ...
                            <div className="card-body">
                                ...
                                <form onSubmit={handleSubmit(onSubmit)}>
                                    ...
                                    <div className="form-group w-50">
                                        ...
                                        <input class="form-check-input" checked={status == true && true}  type="radio" name="gridRadios" id="gridRadios1" value="true" onClick={(e) => setStatus(Boolean(e.target.value))} />
                                        <label class="form-check-label" for="gridRadios1">
                                            Hoạt Động
                                        </label>
                                        </div>
                                        <div class="form-check">
                                        <input class="form-check-input"  checked={status == false && true} type="radio" name="gridRadios" id="gridRadios2" value="false" onClick={(e) => {
                                            setStatus(false);
